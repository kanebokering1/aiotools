      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Split PDF files into separate pages or extract specific page ranges online for free.",
            "featureList": [
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
              ...
              {splitFiles.length > 0 && (
                <div className="border-t pt-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      onClick={downloadAll}
                      className="rounded-md bg-blue-600 border-2 border-blue-700 px-3 py-1 text-sm text-white hover:bg-blue-700 flex items-center gap-1"
                    >
                    ...
                    {splitFiles.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <button
                          ...
                          className="ml-2 rounded bg-blue-600 border-2 border-blue-700 px-2 py-1 text-xs text-white hover:bg-blue-700"
                        >
                          Download
                        </button>
                      </div>
        ...
        <div className="mb-12 flex justify-center">
          <div className="rounded-xl bg-white border border-gray-200 p-6 shadow-sm">
            <ShareButtons 
              url={typeof window !== 'undefined' ? window.location.href : 'https://aiotools.arthacodestudio.com/pdftools/pdf-split'}
              title="PDF Splitter - Split PDF Pages Online Free | AIO Tools"
              description="Split PDF into separate pages or extract specific pages for free. Fast and secure!"
            />
          </div>
        </div>
