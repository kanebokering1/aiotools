      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-lg bg-blue-50 p-6 border border-blue-200">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
            ...
            <li>Optionally exclude similar-looking characters</li>
            <li>Click "Generate New Password" to create a new password</li>
            <li>Click the copy button to copy the password to clipboard</li>
          </ol>
        </div>
      </main>
