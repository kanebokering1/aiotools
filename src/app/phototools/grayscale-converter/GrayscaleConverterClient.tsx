...
export default function GrayscaleConverterClient() {
  const seoContent = getToolSEOContent("grayscale-converter");
  const relatedTools = getRelatedTools("grayscale-converter");
